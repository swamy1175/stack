...
import 'package:stack/dropdown_widget.dart';
...
class MyStashedInventory2 extends StatefulWidget {
  const MyStashedInventory2({super.key});

  @override
  State<MyStashedInventory2> createState() => _MyStashedInventory2State();
}
class _MyStashedInventory2State extends State<MyStashedInventory2> {
  int selectedMonth = -1;
  String selectedMonthValue = 'select value';
  List<FormModel> monthList = <FormModel>[
    FormModel(key: 1,value:'January'),
    FormModel(key: 2,value:'February'),
    FormModel(key: 3,value:'March'),
    FormModel(key: 4,value:'April'),
    FormModel(key: 5,value:'May'),
    FormModel(key: 6,value:'June'),
    FormModel(key: 7,value:'July'),
    FormModel(key: 8,value:'August'),
    FormModel(key: 9,value:'September'),
    FormModel(key: 10,value:'October'),
    FormModel(key: 11,value:'November'),
    FormModel(key: 12,value:'December'),];
  onChangeMonth(FormModel formModel) {
  setState(() {
    selectedMonth = formModel.key;
    selectedMonthValue = formModel.value;
  });
  }
  @override
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 14.0,bottom: 4),
                  child: CustomTextFeild(hintText: 'Select Product Category',suffixIcon: Icon(Icons.arrow_forward_ios),),
                ),
                Padding(
                  padding: const EdgeInsets.only(left: 14.0,bottom: 4),
                  child: Text(
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: 360,
                    child: DropDownWidget(dropdownList: monthList,
                      onValueChanged: (FormModel formModel)=> onChangeMonth(formModel),
        ),
                  ),
                ),
                Padding(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: ()async{
                                          await appExt.push(EditProductDetails(), context);
                                        },
                                        child: Container(
                                          // group93H8H (0:180)
                                          width: 53,
